...
//----------------------------------------------------------------------------------------------------
	...
	this.textFont = "sans-serif";	// text font family
	this.textSize = 11;					// text font size (pixels)
	this.textColor = "#29AA12";			// text color
	this.textAlign = "center";			// text alignment: "left", "right" or "center"
	this.border = "1px solid #cecece";	// border (CSS spec: size style color, e.g. "1px solid #D00000")
	this.padding = 4;					// padding (pixels)
	this.opacity = 100;					// opacity (1 - 100); not supported by all browsers
