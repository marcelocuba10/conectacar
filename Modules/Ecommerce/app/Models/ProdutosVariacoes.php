...
class ProdutosVariacoes extends Model{
	...
	public $table = 'produtos_variacoes';
	public $primarykey = 'id';
	public $fillable = [
		'produtos_chamada','conteudo','grupo','valor','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
