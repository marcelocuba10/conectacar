...
class ProdutosCategorias extends Model{
	...
	public $table = 'produtos_categorias';
	public $primarykey = 'id';
	public $fillable = [
		'produtos_id','categorias_id','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
