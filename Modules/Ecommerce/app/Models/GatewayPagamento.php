...
class GatewayPagamento extends Model{
	...
	public $table = 'gateway_pagamento';
	public $primarykey = 'id';
	public $fillable = [
		'emp_nome','chaves','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
