...
class CarrinhoProdutos extends Model{
	...
	public $table = 'carrinho_produtos';
	public $primarykey = 'id';
	public $fillable = [
		'carrinho_produtos_variacoes_qdade','valor','total','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
