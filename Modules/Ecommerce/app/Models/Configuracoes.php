...
class Configuracoes extends Model{
	...
	public $fillable = [
		'emp_root','label','value','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
    ...
    public function getconfiguracoesFilhoAttribute() { return $this->attributes['configuracoesFilho'] = Configuracoes::where('root',$this->id)->get(); }
