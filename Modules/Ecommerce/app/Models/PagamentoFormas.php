...
class PagamentoFormas extends Model{
	use SoftDeletes;

	public $connection = 'ecommerce';
	public $table = 'pagamento_formas';
	public $primarykey = 'id';
	public $fillable = [
		'emp_nome','compensacao_em_dias','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
