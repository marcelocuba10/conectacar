...
class ProdutosMarcas extends Model{
	...
	public $table = 'produtos_marcas';
	public $primarykey = 'id';
	public $fillable = [
		'emp_id','nome','logotipo','site','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
