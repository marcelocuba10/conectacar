...
class ProdutosEstoque extends Model{
	...
	public $table = 'produtos_estoque';
	public $primarykey = 'id';
	public $fillable = [
		'produtos_variacoes_id','quantidade','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
