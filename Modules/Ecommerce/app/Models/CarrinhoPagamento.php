...
class CarrinhoPagamento extends Model{
	use SoftDeletes;

	public $connection = 'ecommerce';
	public $table = 'carrinho_pagamento';
	public $primarykey = 'id';
	public $fillable = [
		'carrinho_forma_pagamento_valor','subtotal','total','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
