...
class Textos extends Model{
	...
	public $fillable = [
		'emp_id','local_uso','ordem','titulo','texto','imagem','link','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
