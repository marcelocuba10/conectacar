...
class TicketsVariacoes extends Model{
	use SoftDeletes;

	public $connection = 'base_principal';
	public $table = 'tickets_variacoes';
	public $primarykey = 'id';
	public $fillable = [
		'emp_id','tipo','texto','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
