...
class Tickets extends Model{
	...
	public $fillable = [
		'emp_id','leitura','finalizado','hash','root','users_id','assunto','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
