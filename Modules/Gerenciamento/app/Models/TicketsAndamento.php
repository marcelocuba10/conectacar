...
class TicketsAndamento extends Model{
	use SoftDeletes;

	public $connection = 'base_principal';
	public $table = 'tickets_andamento';
	public $primarykey = 'id';
	public $fillable = [
		'ticket_id','tipo','prioridade','status','mensagem','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
