...
class CamposParaDocumentos extends Model{
	use SoftDeletes;

	public $connection = 'base_principal';
	public $table = 'campos_para_documentos';
	public $primarykey = 'id';
	public $fillable = [
		'emp_id','local_uso','grupo','label','chave','correspondente','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
