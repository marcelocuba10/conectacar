...
class ContasReceber_Repositorie_Campos{
    ...
    const url = '/gerenciamento/painel/financeiro/contas_receber';
    ...
    static function index($id = ''){
        ...
        $data = Model('Gerenciamento','Financeiro')::where('tipo','contas_receber')->orderby('vencimento')->get();
        ...
        foreach( $data as $key=>$d ){
            ...
            if( is_null($d['data_pagamento']) ){
                $d['acoes'] .= Componentes::MontaBotao(['cor'=>'danger','url'=>ContasReceber_Repositorie_Campos::url.'/'.$d['id'].'','tipo'=>'BotaoRemover','icone'=>'fa fa-trash','titulo'=>'Remover','classHref'=>'botaoRemover']);

                $d['acoes'] .= Componentes::MontaBotao(['cor'=>'warning','url'=>ContasReceber_Repositorie_Campos::url.'/'.$d['id'].'/edit','tipo'=>'LinkGeralIcone','icone'=>'fa fa-pencil','titulo'=>'Editar']);

                $d['acoes'] .= Componentes::MontaBotao(['cor'=>'info','url'=>ContasReceber_Repositorie_Campos::url.'/'.$d['id'].'/receber','tipo'=>'LinkGeralIcone','icone'=>'fa fa-download','titulo'=>'Baixar']);
            } else {
