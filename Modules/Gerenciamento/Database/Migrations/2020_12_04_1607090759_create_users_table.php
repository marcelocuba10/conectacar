...
class CreateUsersTable extends Migration
{
    public function up()
    {
		...
		$table->string('razao')->nullable()->default('NULL');
		$table->string('fantasia')->nullable()->default('NULL');
		$table->string('url')->nullable()->default('NULL');
		$table->string('modulo')->nullable()->default('NULL');
		$table->integer('status_cadastro',11)->nullable()->default('NULL');
		$table->string('nivel')->nullable()->default('NULL');
		$table->integer('tentativas',11)->nullable()->default('NULL');
		$table->integer('tema',11)->nullable()->default('NULL');
