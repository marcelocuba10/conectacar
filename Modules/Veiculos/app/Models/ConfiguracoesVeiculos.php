...
class ConfiguracoesVeiculos extends Model{
	use SoftDeletes;

	public $connection = 'veiculos';
	public $table = 'configuracoes_veiculos';
	public $primarykey = 'id';
	public $fillable = [
		'emp_id','root','tipo','valor','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from','_token'
	];
	public $hidden = [
