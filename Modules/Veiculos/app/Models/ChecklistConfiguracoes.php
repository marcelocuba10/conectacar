...
class ChecklistConfiguracoes extends Model{
	use SoftDeletes;

	public $connection = 'veiculos';
	public $table = 'checklist_configuracoes';
	public $primarykey = 'id';
	public $fillable = [
		'emp_id','titulo','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','created_from','updated_from','deleted_from'
	];
	public $hidden = [
