            ...
            <div class="row row-fix">
              <div class="col-sm-12">
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Montadora') !!}:<p>{!! !empty($carroSelecionado['pegaMontadora']) ? $carroSelecionado['pegaMontadora'] : 'pegaMontadora' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Tipo') !!}:<p>{!! !empty($carroSelecionado['pegaTipo']) ? $carroSelecionado['pegaTipo'] : 'pegaTipo' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Câmbio') !!}:<p>{!! !empty($carroSelecionado['pegaCambio']) ? $carroSelecionado['pegaCambio'] : 'pegaCambio' !!}
                        </p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Cor') !!}:<p>{!! !empty($carroSelecionado['pegaCor']) ? $carroSelecionado['pegaCor'] : 'pegaCor' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Carroceria') !!}:<p>{!! !empty($carroSelecionado['pegaCarroceria']) ? $carroSelecionado['pegaCarroceria'] : 'pegaCarroceria' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Portas') !!}:<p>{!! !empty($carroSelecionado['pegaPorta']) ? $carroSelecionado['pegaPorta'] : 'pegaPorta' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Motorização') !!}:<p>{!! !empty($carroSelecionado['pegaMotorizacao']) ? $carroSelecionado['pegaMotorizacao'] : 'pegaMotorizacao' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Combustível') !!}:<p>{!!!empty($carroSelecionado['pegaCombustivel']) ? $carroSelecionado['pegaCombustivel'] : 'pegaCombustivel' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('KM') !!}:<p>{!! !empty($carroSelecionado['km']) ? $carroSelecionado['km'] : 'km' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Final da placa') !!}:<p>{!! substr(!empty($carroSelecionado['placa']) ? $carroSelecionado['placa'] : null ,-1) !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Ano') !!}:<p>{!! !empty($carroSelecionado['ano_veiculo']) ? $carroSelecionado['ano_veiculo'] : 'ano_veiculo' !!}</p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-sm-3">
                    <ul class="ul3">
                      <li style="list-style: 1">{!! trataTraducoes('Versão') !!}:<p>{!! !empty($carroSelecionado['versao']) ? $carroSelecionado['versao'] : 'versao' !!}</p>
                      </li>
                    </ul>
                  </div>
                </div>
