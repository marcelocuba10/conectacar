...
<section id="home" class="section swiper-container swiper-slider swiper-slider-1" data-loop="true" data-autoplay="false" data-simulate-touch="false" data-slide-effect="fade">
    <div class="swiper-wrapper text-center">
        <div class="swiper-slide context-dark" data-slide-bg="{!! verificaImagemSistem($data['imagen']) !!}">
        ...
        <div class="swiper-slide context-dark" data-slide-bg="{!! verificaImagemSistem($data['imagen']) !!}" style="background-position: 50% 50%;">
            <div class="swiper-slide-caption">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                    ...
                    <div class="thumbnail clearfix">
                        ...
                        <div class="caption">
                            ...
                            <div class="product-item-title">
                                <a href="details">2010 Ford Mustang / YELLOW</a>
                            </div>
                            ...
                            <div class="link">
                                <a href="details" class="btn-default btn1">
                                    <span>READ MORE</span>
                                </a>
                            </div>
                        </div>
                ...
                <div class="product-item-classic">
                    <div class="thumbnail clearfix">
                        ...
                        <div class="caption">
                            ...
                            <div class="product-item-title">
                                <a href="details">1950 Bugatti / BLACK</a>
                            </div>
                ...
                <div class="product-item-classic">
                    <div class="thumbnail clearfix">
                        ...
                        <div class="caption">
                            ...
                            <div class="product-item-title">
                                <a href="details">2013 Mercedes C / WHITE</a>
                            </div>
...
<div id="welcome" class="section text-center">
    <section class="parallax-container parallax1" data-parallax-img="{!! verificaImagemSistem($data['imagen']) !!}">
                                        ...
                                        <div class="thumbnail clearfix">
                                            ...
                                            <div class="caption">
                                                ...
                                                <div class="product-minimal-title">
                                                    <a href="detalhes"> BMW M6 Sport Hybrid</a>
                                                </div>
                                                <div class="info">
                                    ...
                                    <div class="product-minimal">
                                        <div class="thumbnail clearfix">
                                            ...
                                            <div class="caption">
                                                ...
                                                <div class="product-minimal-title">
                                                    <a href="details"> 2016 Ferrari Testarosa</a>
                                                </div>
                                                <div class="info">
                                    ...
                                    <div class="product-minimal">
                                        <div class="thumbnail clearfix">
                                            ...
                                            <div class="caption">
                                                <p class="small">REGISTERED 2015</p>
                                                <div class="product-minimal-title">
                                                    <a href="details"> 2016 Bugatti Veyron</a>
                                                </div>
                                                <div class="info">
                                    ...
                                    <div class="product-minimal">
                                        <div class="thumbnail clearfix">
                                            ...
                                            <div class="caption">
                                                ...
                                                <div class="product-minimal-title">
                                                    <a href="details"> 2017 Lexus-AMG C63</a>
                                                </div>
                                                <div class="info">
                                    ...
                                    <div class="product-minimal">
                                        <div class="thumbnail clearfix">
                                            ...
                                            <div class="caption">
                                                <p class="small">REGISTERED 2017</p>
                                                <div class="product-minimal-title">
                                                    <a href="details"> 2017 Mercedes - AMG</a>
                                                </div>
                                                <div class="info">
                                    ...
                                    <div class="product-minimal">
                                        <div class="thumbnail clearfix">
                                            ...
                                            <div class="caption">
                                                <p class="small">REGISTERED 2015</p>
                                                <div class="product-minimal-title">
                                                    <a href="details"> BMW M6 Sport Hybrid</a>
                                                </div>
                                                <div class="info">
                                                    <span class="price">24,380</span>
                                                    <span class="speed">35,000 KM</span>
...
<div class="parallax-container parallax1" data-parallax-img="{!! verificaImagemSistem($data['imagen']) !!}">
    <div class="parallax-content">
        <div class="section">
            <div class="container">
                <div class="row row-fix">
