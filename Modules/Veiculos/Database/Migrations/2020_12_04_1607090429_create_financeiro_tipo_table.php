...
class CreateFinanceiroTipoTable extends Migration
{
    public function up()
    {
        Schema::create('financeiro_tipo', function (Blueprint $table) {

		$table->increments(id);
		$table->integer('emp_id',11)->default('0');
		$table->string('tipo')->nullable()->default('NULL');
		$table->string('nome')->nullable()->default('NULL');
		$table->integer('prazo',11)->nullable()->default('NULL');
    ...
    {
        Schema::dropIfExists('financeiro_tipo');
    }
}