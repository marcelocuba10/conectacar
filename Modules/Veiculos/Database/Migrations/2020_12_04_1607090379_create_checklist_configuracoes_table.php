...
class CreateChecklistConfiguracoesTable extends Migration
{
    public function up()
    {
        Schema::create('checklist_configuracoes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('checklist_configuracoes');
    }
}