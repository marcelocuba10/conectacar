...
class Caixa_Repositorie_Campos{



    const url = '/veiculos/painel/financeiro/caixa';
    ...
    static function index($id = ''){
        ...
        $dados = [
            ...
            'rota_geral'=>Caixa_Repositorie_Campos::url,

            'titulo_pagina'=>'Início|Veículos|Financeiro|Caixa',
        ...
        $data = Model('Veiculos','VeiculosFinanceiro')::get();
        ...
        foreach( $data as $key=>$d ){
            ...
            if( is_null($d['data_pagamento']) ){
                ...
                $d['acoes'] .= Componentes::MontaBotao(['cor'=>'danger','url'=>Caixa_Repositorie_Campos::url.'/'.$d['id'].'','tipo'=>'BotaoRemover','icone'=>'fa fa-trash','titulo'=>'remover','classHref'=>'botaoRemover']);



                $d['acoes'] .= Componentes::MontaBotao(['cor'=>'warning','url'=>Caixa_Repositorie_Campos::url.'/'.$d['id'].'/edit','tipo'=>'LinkGeralIcone','icone'=>'fa fa-pencil','titulo'=>'editar']);



                $d['acoes'] .= Componentes::MontaBotao(['cor'=>'info','url'=>Caixa_Repositorie_Campos::url.'/'.$d['id'].'/pagar','tipo'=>'LinkGeralIcone','icone'=>'fa fa-download','titulo'=>'editar']);

            } else {

                $d['acoes'] .= Componentes::MontaBotao(['cor'=>'info','url'=>Caixa_Repositorie_Campos::url.'/'.$d['hash_pagamento'].'/recibo','tipo'=>'LinkGeralIcone','icone'=>'fa fa-file-pdf-o','titulo'=>'recibo','target' => '_blank']);
...
*/
        ...
        $dados = Caixa_Repositorie_Campos::index()['dados'];
