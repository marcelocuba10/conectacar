...
class QuemSomos_Repositorie_Campos{

    const url = '/veiculos/painel/website/quem_somos';

    static function index($id = ''){
        $dados = [
            'rota_geral'=>QuemSomos_Repositorie_Campos::url,
            'titulo_pagina'=>'Início|Website|Quem somos',
            'botoes_da_datatable'=>Componentes::MontaBotao([
                'cor'=>'primary',
                'url'=>QuemSomos_Repositorie_Campos::url.'/create',
                'tipo'=>'LinkGeralIcone',
        ...
        foreach( $data as $key => $d ){
            ...
            $d['acoes'] .= Componentes::MontaBotao(['cor'=>'danger','url'=>QuemSomos_Repositorie_Campos::url.'/'.$d['hash_id'].'','tipo'=>'BotaoRemover','icone'=>'fa fa-trash','titulo'=>'Remover','classHref'=>'botaoRemover']);
            $d['acoes'] .= Componentes::MontaBotao(['cor'=>'warning','url'=>QuemSomos_Repositorie_Campos::url.'/'.$d['hash_id'].'/edit','tipo'=>'LinkGeralIcone','icone'=>'fa fa-pencil','titulo'=>'Editar']);
        } 
...
$dados = QuemSomos_Repositorie_Campos::index()['dados'];
