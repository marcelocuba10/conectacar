		...
		<div class="col-lg-12">
			<div class="ibox ">
				...
				<div class="ibox-title">
					<h5>{!! montaBreadcrumb('Início|Veículos|Checklist') !!}</h5>
				...
				<div class="ibox-content">
					<div class="table-responsive">
						...
						<div class="row">
							@forelse( $dados['checklist'] as $key => $checklist )
							<div class="col-lg-4" style="line-height: 1; background-color: {!! ( $key % 2 == 0 ? '#dedede' : '#ffffff' ) !!}">
								<div class="row" style="padding: 5px;">
									<div class="col-lg-12 text-left">
										{!! $checklist['camposAdicionais']['titulo'] !!}
									</div>
									<div class="col-lg-12 text-right">
										<strong>{!! trataTraducoes($checklist['valor']) !!}</strong>
									</div>
								</div>
							</div>
							@empty
