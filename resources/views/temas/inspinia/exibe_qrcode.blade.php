				...
				<div class="ibox-title">
					...
					<div class="ibox-tools">
						<a class="btn-apagar btn btn-warning btn-xs float-right" data-toggle="tooltip" data-placement="top" style="margin: 0px 2px;" onclick="montaTela('{!! $dados['dados']['rota_geral'] !!}');" title="{!! trataTraducoes('voltar') !!}">
							...
							<span style="color: #fff">{!! trataTraducoes('listar_recebimentos') !!}</span>
						</a>
					</div>
				</div>
				<div class="ibox-content">
					...
					<div class="row">
						...
						<div class="col-lg-1" style="padding-top: 7px;">
							<a onclick="copiaConteudo('{!! trataTraducoes('link_de_recomendacao_copiado_com_sucesso') !!}','{!! trataTraducoes('sucesso') !!}','success','copiarConteudoHTML')" style="cursor: pointer;">
