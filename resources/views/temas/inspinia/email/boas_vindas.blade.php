                  ...
                  <div style="padding:0 30px;background:#fff">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size:14px;line-height:30px;padding:20px 0;color:#666">{!! trataTraducoes('Bem vindo a') !!} {!! site_id()['name'] !!}!
                          </td>
                        </tr>
                        <tr>
                          <td style="font-size:12px;line-height:25px;padding:20px 0 10px 0;color:#666;font-weight:bolder"> 
                            <span style="font-size:14px;color:red">{!! trataTraducoes('Dicas de segurança') !!}</span>
                            <br>
                            {!! trataTraducoes('Não forneça sua senha para estranhos') !!}
                          </td>
                          <td>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding:30px 0 15px 0;font-size:12px;color:#999;line-height:20px">{!! trataTraducoes('Bem vindo') !!}<br>{!! trataTraducoes('Equipe') !!} {!! trataTraducoes('Mensagem automática, n') !!}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
