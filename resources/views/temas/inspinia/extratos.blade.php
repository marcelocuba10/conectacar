		...
		<div class="col-lg-12">
			<div class="ibox ">
				...
				<div class="ibox-content">
					<div align="center">
						<form name="formulario" id="formulario" action="{!! url('/financial/extracts') !!}" method="GET" onsubmit="return this.botaoEnviar{!! StatusDoSistema() === 0 ? 1 : Null !!}.disabled=true, this.botaoEnviar{!! StatusDoSistema() === 0 ? 1 : Null !!}.innerHTML=' trataTraducoes('filtrando') !!}'">
							<div class="row">
						...
						<div class="row" style="width: 100% !important"> 
							<table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-striped">
								<tr>
									...
									<td class="text-left" style="width: 15%;">{!! trataTraducoes('usuarios') !!}</td>
								...
								@empty
								<tr>
									<td colspan="6" style="text-align: center !important;">{!! trataTraducoes('nenhum_registro_encontrado_para_a_data_informada') !!}</td>
								</tr>
								@endforelse
