            ...
            <div class="ibox ">
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" style="padding-right: 5px;">
                        <a onclick="montaTela('{!! $dados['dados']['rota_geral'] !!}');" title="@lang('global-'.idiomaPadrao().'.voltar')"><i class="fa fa-mail-reply"></i> @lang('global-'.idiomaPadrao().'.cancelar') </a>
                    </div>
                </div>
                <div class="ibox-content">
                    <form name="formulario" id="formulario" action="{!! url($dados['dados']['rota_geral']) !!}" method="post" enctype="multipart/form-data" onsubmit="return this.botaoEnviar{!! StatusDoSistema() === 0 ? 1 : Null !!}.disabled=true, this.botaoEnviar{!! StatusDoSistema() === 0 ? 1 : Null !!}.innerHTML='@lang('global-'.idiomaPadrao().'.enviando')',">
                        @csrf
