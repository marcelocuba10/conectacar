		...
		<span v-if="cameras.length === 0" class="empty">
			<div class="row">
				...
				*/
				...
				<div class="col-md-1">&nbsp;</div>
				<div class="col-md-10">
					<form name="formulario" id="formulario" action="" method="post" enctype="multipart/form-data" onsubmit="return this.botaoEnviar{!! StatusDoSistema() === 0 ? 1 : Null !!}.disabled=true, this.botaoEnviar{!! StatusDoSistema() === 0 ? 1 : Null !!}.innerHTML='{!! trataTraducoes('Enviando') !!}'">
						@csrf
