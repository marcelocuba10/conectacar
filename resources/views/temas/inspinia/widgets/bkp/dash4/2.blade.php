            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <small class="col-sm-6 float-right">
                        <button class="btn btn-sm btn-link float-right no-padding"><i class="fa fa-copy"></i> <small>{!! trataTraducoes('copiar_codigo_de_indicacao') !!}</small> </button>
                    </small>
                    @else
                    <p class="text-center">
                        {!! trataTraducoes('explicacao_matricula_inexistente') !!}
                    </p>
                    @endif
                </div>
            </div>
