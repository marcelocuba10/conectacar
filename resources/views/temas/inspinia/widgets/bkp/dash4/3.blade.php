        ...
        <div class="ibox-content">
            <div>
                <h3 class="font-bold no-margins">
                    {!! trataTraducoes('niveis_mmn') !!}
                    <small class="float-right">
                        {!! trataTraducoes('perna_escolhida') !!}: <span id="pernaMMNSelecionadaDashboard">{!! dadosUsuarioCompleto()['perna_mmn'] !!}</span> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="stat-list m-t-lg">
                        ...
                        <li>
                            <h2 class="no-margins">{!! str_replace('usuarios_no_nivel_',trataTraducoes('nivel') . ' ',$data['chave']) !!}</h2>
                            <small>{!! trataTraducoes('necessario') !!}: {!! $data['valor']!!}</small>
