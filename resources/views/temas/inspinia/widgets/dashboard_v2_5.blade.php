			...
			<div class="ibox-title">
				...
				<div class="ibox-tools">
					...
					<a onclick="montaTela('/registrations/wallet/create')" class="btn btn-primary btn-xs">
						<i class="fa fa-plus"></i> {!! trataTraducoes('nova_carteira') !!}
					</a>
					@endif
				</div>
				@endif
						...
						<table class="table table-hover margin bottom">
							<thead>
								<tr>
									...
									<th style="width: 20%">{!! trataTraducoes('nome_da_carteira') !!}</th>
									<th style="width: 15%" class="text-center">{!! trataTraducoes('moeda') !!}</th>
									<th style="width: 23%" class="text-center">{!! trataTraducoes('hash') !!}</th>
									<th style="width: 20%" class="text-right">{!! trataTraducoes('saldo_da_carteira') !!} <small>( TDX )</small></th>
									<th style="width: 20%" class="text-right">{!! trataTraducoes('saldo_convertido') !!} <small>( USD )</small></th>
								</tr>
							</thead>
							<tbody>
								@php
