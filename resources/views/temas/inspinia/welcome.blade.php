		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #F4F4B6;">
			...
			<tr>
				...
				<td style="width: 70%">
					...
					<p><i class="fa fa-calendar"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('Data do pagamento') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{!! dateBdToApp($data['created_at']) !!}</span></p>
					<p><i class="fa fa-hourglass"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('Hora do pagamento') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{!! explode(' ',dateTimeBdToApp($data['created_at']))[1] !!}</span></p>
					...
					@else
						<p><i class="fa fa-money"></i> <span style="text-transform: uppercase !important;font-size: 14pt !important;font-weight: bold !important;">{!! trataTraducoes('Valor do pagamento') !!}: </span> <span style="text-transform: uppercase !important;font-size: 12pt !important;">{{ moeda_usuario() }} {!! conversorMoedas($data['valor'], moeda_padrao(), moeda_usuario(),true)!!}</span></p>
