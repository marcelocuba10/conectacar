        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <input type="text" id="myInput" onkeyup="myFunction()" class="form-control" placeholder="{!! trataTraducoes('filtre_seus_contatos') !!}">
                    ...
                    <div class="col-md-12">
                        <div class="row" id="myTable" style="overflow: hidden;">
                            ...
                            @empty
                            <p class="text-center">{!! trataTraducoes('nenhum_contato_encontrado_para_listar') !!}</p>
                            @endforelse
                        </div>
                    </div>
                </div>
