            ...
            <div class="ibox ">
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" style="padding-right: 5px;">
                        <a class="btn-apagar btn btn-warning btn-xs float-right" data-toggle="tooltip" data-placement="top" style="margin: 0px 2px;" onclick="montaTela('{!! $dados['dados']['rota_geral'] !!}');" title="{!! trataTraducoes('voltar') !!}">
                            ...
                            <span style="color: #fff">{!! trataTraducoes('cancelar') !!}</span>
                        </a>
                    </div>
                </div>
                <div class="ibox-content">
                    <form name="formulario" id="formulario" action="{!! url($dados['dados']['rota_geral']) !!}" method="post" enctype="multipart/form-data" onsubmit="return this.botaoEnviar{!! StatusDoSistema() === 0 ? 1 : Null !!}.innerHTML='{!! trataTraducoes( !empty($dados['labelFormularioEnviar']) ? $dados['labelFormularioEnviar'] : 'processando' ) !!}',">
                        @csrf
                        {!! montaCamposFormulario(['formulario' => 12,'label' => 'parceiro_comercial','nome_no_banco_de_dados' => 'emp_id_pagamento','required'=>1,'tipo'=>'select','tabela_relacional'=>'Consulta_Redes_Lojas','icone'=>['tipo'=>'icone','arquivo'=>'fa fa-user-o'],]) !!}
                        ...
                        <?php
                        /*
                        {!! montaCamposFormulario(['formulario' => 12,'label' => 'carteira_destino','nome_no_banco_de_dados' => 'carteira_id','required'=>1,'tipo'=>'select','tabela_relacional'=>'Consulta_Carteiras_Usuario','valor_inicial' => '','icone'=>['tipo'=>'icone','arquivo'=>'fa fa-drivers-license-o'],]) !!}

                        {!! montaCamposFormulario(['formulario' => 12,'label' => 'valor','nome_no_banco_de_dados' => 'total','required'=>1,'maxlength' => 10,'mascara'=>'mascaraMoeda','icone'=>['tipo'=>'icone','arquivo'=>'fa fa-usd'],'style'=>'text-align:right',]) !!}

                        {!! montaCamposFormulario(['label'=>'obs','tipo'=>'labelComTexto','valor_inicial'=>trataTraducoes('texto_informativo_validade_deposito'),]) !!}



                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">{!! trataTraducoes('valor_btc') !!}</label>
                            <div class="col-sm-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="max-width: 47% !important;">
                                        <div class="input-group m-b">
                                            <input type="radio" name="valor_informado" id="valor_informado_usd" value="usd" style="width: 1px !important; height: 1px !important;">
                            ...
                            <label class="col-sm-2 col-form-label text-right">{!! trataTraducoes('valor_usd') !!}</label>
                        </div>
