...
<!-- https://livedemo00.template-help.com/wt_58160/ -->
...
<html lang="en" class="wide wow-animation">
  ...
  <body>
    ...
    <div class="page text-center">
      ...
      <!-- Page Header-->
      <header class="page-head main-page" style="background-color: black">
        <!-- RD Navbar-->
            ...
            <div class="rd-navbar-inner">
              <div class="rd-navbar-nav-wrap-outer">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand--><a href="index.html" class="rd-navbar-brand">
                    <div class="brand-name"><span> lim</span><span class="text-primary">o</span></div></a>
                </div>
              </div>
              <!-- RD Navbar Nav-->
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                  <li class="active"><a href="/5">Home</a></li>
