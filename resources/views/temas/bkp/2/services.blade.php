...
<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - April 07, 2014!</div>
    <div class="container_12">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img1.jpg" alt="">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img2.jpg" alt="">
                    <div class="text1 color2">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img3.jpg" alt="">
                    <div class="text1 color2">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img4.jpg" alt="">
                    <div class="text1 color2">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img5.jpg" alt="">
                    <div class="text1 color2">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img6.jpg" alt="">
                    <div class="text1 color2">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img7.jpg" alt="">
                    <div class="text1 color2">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img8.jpg" alt="">
                    <div class="text1 color2">
        ...
        <div class="grid_4">
            <div class="box">
                <div class="maxheight">
                    <img src="/temas/page186/images/page4_img9.jpg" alt="">
                    <div class="text1 color2">
