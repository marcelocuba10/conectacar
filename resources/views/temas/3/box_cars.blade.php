<div class="grid_3" style="margin-top: 30px;">
    <div class="box1">
      <h4 class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
        <a href="tema/3/detail/{!! !empty($retornaCarros['hash_id']) ? $retornaCarros['hash_id'] : Null !!}">{!! !empty($retornaCarros['nome']) ? $retornaCarros['nome'] : 'nome_veiculo' !!}</a>
      </h4>
      <img href="tema/3/detail/{!! !empty($retornaCarros['hash_id']) ? $retornaCarros['hash_id'] : Null !!}" class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" src="{!! verificaImagemSistem("imagen") !!}" alt=""/>
      ...
      <div class="info2 wow fadeIn" data-wow-duration="1s" data-wow-delay=".3s">
        ...
        <a class="btn-default" href="/tema/3/detail">
